...
use commands::{
    ai::{
        ...
        ask_recall_clear_session, ask_recall_get_session, ask_recall_new_session,
        embed_all_memories, find_related, list_entities_for_memory,
        list_memories_by_entity, ocr_rebuild_index, ocr_run_for_memory, semantic_search,
    },
