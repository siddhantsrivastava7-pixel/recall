...
use commands::{
    ai::{
        ...
        ai_status, ai_unload_llm, ask_recall, ask_recall_cancel, embed_all_memories,
        find_related, list_entities_for_memory, list_memories_by_entity,
        ocr_rebuild_index, ocr_run_for_memory, semantic_search,
    },
