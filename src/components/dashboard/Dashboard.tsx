...
// NOTE: Dashboard.tsx is currently unused — MainWindow renders
// `HomeBriefing` for `view === "dashboard"`. Surfaces live in
// HomeBriefing instead. Keeping this file around because the
// search wiring and search-overlay support live here and there
// are still references from elsewhere.
import {
